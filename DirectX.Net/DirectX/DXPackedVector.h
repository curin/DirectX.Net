...
#include "PackedVector/XMXDEC4.h"
#include "PackedVector/XMDECN4.h"
#include "PackedVector/XMDEC4.h"
    ...
    namespace PackedVectors
    {
        ...
        public:
            ...
            ****************************************************************************/
            ...
            static inline void XMStoreU565([Out]XMU565% pDestination, DirectX::Math::XMVECTOR^ V);
            static inline void XMStoreFloat3PK([Out]XMFLOAT3PK% pDestination, DirectX::Math::XMVECTOR^ V);
            static inline void XMStoreFloat3SE([Out]XMFLOAT3SE% pDestination, DirectX::Math::XMVECTOR^ V);
