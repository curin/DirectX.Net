...
{
	pin_ptr<DirectX::PackedVectors::XMU565> source = &pSource;
	return gcnew DirectX::Math::XMVECTOR(DirectX::XMLoadU565((DirectX::PackedVector::XMU565*)source));
}
...
{
	pin_ptr<DirectX::PackedVectors::XMFLOAT3PK> source = &pSource;
	return gcnew DirectX::Math::XMVECTOR(DirectX::XMLoadFloat3PK((DirectX::PackedVector::XMFLOAT3PK*)source));
}
...
{
	pin_ptr<DirectX::PackedVectors::XMFLOAT3SE> source = &pSource;
	return gcnew DirectX::Math::XMVECTOR(DirectX::XMLoadFloat3SE((DirectX::PackedVector::XMFLOAT3SE*)source));
}
...
{
	pin_ptr<DirectX::PackedVectors::XMXDECN4> source = &pSource;
	return gcnew DirectX::Math::XMVECTOR(DirectX::XMLoadXDecN4((DirectX::PackedVector::XMXDECN4*)source));
}

inline DirectX::Math::XMVECTOR^ DirectX::PackedVectors::PackedVectorMath::XMLoadUDecN4(DirectX::PackedVectors::XMUDECN4% pSource)
{
	pin_ptr<DirectX::PackedVectors::XMUDECN4> source = &pSource;
	return gcnew DirectX::Math::XMVECTOR(DirectX::XMLoadUDecN4((DirectX::PackedVector::XMUDECN4*)source));
}
...
{
	pin_ptr<DirectX::PackedVectors::XMUDECN4> source = &pSource;
	return gcnew DirectX::Math::XMVECTOR(DirectX::XMLoadUDecN4_XR((DirectX::PackedVector::XMUDECN4*)source));
}

inline DirectX::Math::XMVECTOR^ DirectX::PackedVectors::PackedVectorMath::XMLoadUDec4(DirectX::PackedVectors::XMUDEC4% pSource)
{
	pin_ptr<DirectX::PackedVectors::XMUDEC4> source = &pSource;
	return gcnew DirectX::Math::XMVECTOR(DirectX::XMLoadUDec4((DirectX::PackedVector::XMUDEC4*)source));
}
...
{
	pin_ptr<DirectX::PackedVectors::XMUNIBBLE4> source = &pSource;
	return gcnew DirectX::Math::XMVECTOR(DirectX::XMLoadUNibble4((DirectX::PackedVector::XMUNIBBLE4*)source));
}

inline DirectX::Math::XMVECTOR^ DirectX::PackedVectors::PackedVectorMath::XMLoadU555(DirectX::PackedVectors::XMU555% pSource)
{
	pin_ptr<DirectX::PackedVectors::XMU555> source = &pSource;
	return gcnew DirectX::Math::XMVECTOR(DirectX::XMLoadU555((DirectX::PackedVector::XMU555*)source));
}
...
inline void DirectX::PackedVectors::PackedVectorMath::XMStoreU565([Out]DirectX::PackedVectors::XMU565% pDestination, DirectX::Math::XMVECTOR^ V)
{
	pin_ptr<DirectX::PackedVectors::XMU565> dest = &pDestination;
	DirectX::PackedVector::XMStoreU565((DirectX::PackedVector::XMU565*)dest, *(DirectX::XMVECTOR*)V);
}

inline void DirectX::PackedVectors::PackedVectorMath::XMStoreFloat3PK([Out]DirectX::PackedVectors::XMFLOAT3PK% pDestination, DirectX::Math::XMVECTOR^ V)
{
	pin_ptr<DirectX::PackedVectors::XMFLOAT3PK> dest = &pDestination;
	DirectX::PackedVector::XMStoreFloat3PK((DirectX::PackedVector::XMFLOAT3PK*)dest, *(DirectX::XMVECTOR*)V);
}

inline void DirectX::PackedVectors::PackedVectorMath::XMStoreFloat3SE([Out]DirectX::PackedVectors::XMFLOAT3SE% pDestination, DirectX::Math::XMVECTOR^ V)
{
	pin_ptr<DirectX::PackedVectors::XMFLOAT3SE> dest = &pDestination;
	DirectX::PackedVector::XMStoreFloat3SE((DirectX::PackedVector::XMFLOAT3SE*)dest, *(DirectX::XMVECTOR*)V);
}
...
{
	pin_ptr<DirectX::PackedVectors::XMXDECN4> dest = &pDestination;
	DirectX::PackedVector::XMStoreXDecN4((DirectX::PackedVector::XMXDECN4*)dest, *(DirectX::XMVECTOR*)V);
}
...
{
	pin_ptr<DirectX::PackedVectors::XMUDECN4> dest = &pDestination;
	DirectX::PackedVector::XMStoreUDecN4((DirectX::PackedVector::XMUDECN4*)dest, *(DirectX::XMVECTOR*)V);
}
...
{
	pin_ptr<DirectX::PackedVectors::XMUDECN4> dest = &pDestination;
	DirectX::PackedVector::XMStoreUDecN4_XR((DirectX::PackedVector::XMUDECN4*)dest, *(DirectX::XMVECTOR*)V);
}
...
{
	pin_ptr<DirectX::PackedVectors::XMUDEC4> dest = &pDestination;
	DirectX::PackedVector::XMStoreUDec4((DirectX::PackedVector::XMUDEC4*)dest, *(DirectX::XMVECTOR*)V);
}
...
{
	pin_ptr<DirectX::PackedVectors::XMUNIBBLE4> dest = &pDestination;
	DirectX::PackedVector::XMStoreUNibble4((DirectX::PackedVector::XMUNIBBLE4*)dest, *(DirectX::XMVECTOR*)V);
}
...
{
	pin_ptr<DirectX::PackedVectors::XMU555> dest = &pDestination;
	DirectX::PackedVector::XMStoreU555((DirectX::PackedVector::XMU555*)dest, *(DirectX::XMVECTOR*)V);
}
