...
namespace DirectX
{
    namespace PackedVectors
    {
        ...
        public value struct XMUSHORTN4
        {
        public:
            ...
            XMUSHORTN4(unsigned short _x, unsigned short _y, unsigned short _z, unsigned short _w)
            {
                x = _x;
                y = _y;
                z = _z;
            ...
            XMUSHORTN4(unsigned long long c)
            {
                v = c;
            }
